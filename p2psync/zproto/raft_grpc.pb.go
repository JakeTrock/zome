...
const (
	Raft_AppendEntries_FullMethodName = "/zproto_raft.Raft/AppendEntries"
	Raft_RequestVote_FullMethodName   = "/zproto_raft.Raft/RequestVote"
	Raft_ClientCommand_FullMethodName = "/zproto_raft.Raft/ClientCommand"
)
...
func (c *raftClient) ClientCommand(ctx context.Context, in *ClientCommandRequest, opts ...grpc.CallOption) (*ClientCommandResponse, error) {
	...
	err := c.cc.Invoke(ctx, Raft_ClientCommand_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRaftServer) ClientCommand(context.Context, *ClientCommandRequest) (*ClientCommandResponse, error) {
